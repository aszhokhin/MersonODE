...
import std.random;
 ...
 int d3eq(double t, double[]  v, double[] d)
...
{ int i,j;
 ...
 int merson(double *t,double *q,ref double[3] y,int n,double *a,double *h,double *o, int *j,int *l,int function (double , double[], double[]) dtu)
{
  ...
  void soleq(int n, int m, ref double[3] x, ref double[8000][3] u, double b, double v,int function (double,double[],double[]) dtu )
  {
    static double a, hn;
    static int i, j, k, l;
